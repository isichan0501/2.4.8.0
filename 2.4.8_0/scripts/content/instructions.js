...
function generateInstructions(conversation, settings, text, forceAddInstructions = false) {
  ...
  const languageInstructions = `**Language instruction:**\nPlease ignore all previous language instructions. From now on, I want you to respond only in language ${selectedLanguage.name} (languageCode: ${selectedLanguage.code}).\n`;
